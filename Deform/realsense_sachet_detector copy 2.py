...
Real-time Object (deformed) detector using Intel RealSense (color + depth).
...
def main():
    parser = argparse.ArgumentParser(description="Real-time Object (deformed) detector using Intel RealSense")
    parser.add_argument("--min-perim", type=float, default=150.0, help="Minimum contour perimeter to consider (default 120.0)")
    parser.add_argument("--max-perim", type=float, default=220.0, help="Maximum contour perimeter to consider (default 200.0)")
    ...
    window_name = "RealSense Object (deformed) Detector"
    ...
    try:
        while True:
            ...
            # If none found, show a hint
                ...
                cv2.putText(display, "No Object found (perimeter filter)", (10, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 255, 255), 2)
